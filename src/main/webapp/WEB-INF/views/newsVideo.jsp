	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="newsVideo">NEWS & VIDEO</a>
					</li>
				...
				<div class="row">
					...
					<tbody>
						<tr>
							...
							<tr>
							<td class="table-style-4"> <iframe src="childNews" height="1150" width="600"  frameborder=0 framespacing=0 marginheight=0 marginwidth=0 marginleft=100px; scrolling=yes vspace=0>></iframe> </td>
							<td class="table-style-4"> <iframe src="childVideo" height="1150" width="600"  frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=yes vspace=0>></iframe> </td>
						</tr>
					</tbody>
					</table>
				</div>
