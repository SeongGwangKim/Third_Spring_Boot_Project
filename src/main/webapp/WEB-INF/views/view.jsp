...
<body>
	...
	<div class="container">
		...
		<a href="bbs" class="btn btn-primary float-end">글 목록</a>
			<%
	...
	<div class="container my-5 fw-bold fs-3">
		<div class="row">
			...
			<form method="post" action="comment" class="comment">
				...
				<textarea type="text" class="form-control mb-3" class="a" placeholder="댓글을 입력하세요" name="comment" maxlength="100" rows="3" ></textarea>
