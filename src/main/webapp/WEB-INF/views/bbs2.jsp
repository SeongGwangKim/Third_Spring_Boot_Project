		...
		<div class="container">
		  <div class="row">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center"><a href="view2?bbsID=<%= list.get(i).getBbsID() %>"><%= list.get(i).getBbsTitle() %></a></td>
				...
				%>
			<form>
			<a href="bbs2?pageNumber=<%=pageNumber - 1 %>" class="btn btn-success float-start"><i class="fas fa-arrow-left"></i>  이전</a>
			<%
				} if(bbsBiz.isEmptyNextPageBBS(pageNumber)){
				%>
			<a href="bbs2?pageNumber=<%=pageNumber + 1 %>" class="btn btn-success float-start"><i class="fas fa-arrow-right"></i>  다음</a>
			<%
				}
				}else{
					BbsBiz2 bbsBiz = new BbsBiz2();
			...
			<%
				...
				%>
			<!--검색-->
				<a href="write2" class="btn btn-primary float-end"><i class="fas fa-pen"></i> 글쓰기</a>
		</div>
