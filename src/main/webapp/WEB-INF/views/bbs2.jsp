...
<%@ page import ="SupplementsWeb.com.biz.BbsBiz2" %>
<%@ page import ="SupplementsWeb.com.vo.BbsVo2" %>
		...
		<div class="row">
			<table class="table table-striped">
				...
				<tbody>
					...
					List<BbsVo2> list = bbsBiz.getBBSByPage(pageNumber);
			...
			<%
					...
					BbsBiz2 bbsBiz = new BbsBiz2();
					List<BbsVo2> list = (List<BbsVo2>)request.getAttribute("searchAns");
					for(int i = 0; i <list.size(); i++){
