...
<%@ page import ="SupplementsWeb.com.biz.BbsBiz" %>
<%@ page import ="SupplementsWeb.com.vo.BbsVo" %>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li ><a href="bbs2">Q&A 게시판</a></li>

				<li class="active"><a href="bbs">후기 게시판</a></li>
		...
		<div class="row">
			<table class="table table-striped">
				...
				<tbody>
					...
					List<BbsVo> list = bbsBiz.getBBSByPage(pageNumber);
				...
				%>
					...
					<tr>
						...
						<td class="table-style-6"><a href="view?bbsID=<%= list.get(i).getBbsID() %>"><%= list.get(i).getBbsTitle() %></a></td>
			...
			<%
					...
					BbsBiz bbsBiz = new BbsBiz();
					List<BbsVo> list = (List<BbsVo>)request.getAttribute("searchAns");
					for(int i = 0; i <list.size(); i++){
