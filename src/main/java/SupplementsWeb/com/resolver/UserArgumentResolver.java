package SupplementsWeb.com.resolver;

import SupplementsWeb.com.annotation.SocialUser;
import SupplementsWeb.com.dao.UserDaoImpl;
import SupplementsWeb.com.domain.User;
import SupplementsWeb.com.domain.enums.SocialType;
...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public UserArgumentResolver(UserDaoImpl userRepository) {
    ...
    private User getUser(User user, HttpSession session) {
        if(user == null) {
            try {
                ...
                user = userDaoImpl.findByEmail(convertUser.getEmail());
                if (user == null) { user = userDaoImpl.save(convertUser); }
